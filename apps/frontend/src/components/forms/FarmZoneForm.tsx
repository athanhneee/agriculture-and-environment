...
export function FarmZoneForm() {
  ...
  const {
    ...
    defaultValues: {
      ...
      description: "",
      area: 0,
      latitude: 10.762622, // default values (Ho Chi Minh city)
    ...
    <div className="w-full max-w-2xl rounded-2xl border bg-card p-6 shadow-sm sm:p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <button
          ...
          className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-primary text-sm font-semibold text-primary-foreground transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto sm:px-6"
        >
          {isSubmitting ? (
